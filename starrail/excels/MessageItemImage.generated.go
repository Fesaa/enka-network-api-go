...
type MessageItemImageAccessor struct {
	...
	_dataID map[json.Number]MessageItemImage
}
...
func (a *MessageItemImageAccessor) GroupData() {
	a._dataID = map[json.Number]MessageItemImage{}
...
func (a *MessageItemImageAccessor) ByID(identifier json.Number) (MessageItemImage, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
