...
type MessageItemRaidEntranceAccessor struct {
	...
	_dataID     map[json.Number]MessageItemRaidEntrance
	_dataRaidID map[json.Number]MessageItemRaidEntrance
}
...
func (a *MessageItemRaidEntranceAccessor) GroupData() {
	a._dataID = map[json.Number]MessageItemRaidEntrance{}
	a._dataRaidID = map[json.Number]MessageItemRaidEntrance{}
...
func (a *MessageItemRaidEntranceAccessor) ByID(identifier json.Number) (MessageItemRaidEntrance, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
...
//
// Error is only non-nil if the source errors out
func (a *MessageItemRaidEntranceAccessor) ByRaidID(identifier json.Number) (MessageItemRaidEntrance, error) {
