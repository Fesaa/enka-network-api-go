...
type TutorialResConfigAccessor struct {
	...
	_dataID         map[json.Number]TutorialResConfig
...
func (a *TutorialResConfigAccessor) GroupData() {
	a._dataID = map[json.Number]TutorialResConfig{}
...
func (a *TutorialResConfigAccessor) ByID(identifier json.Number) (TutorialResConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
