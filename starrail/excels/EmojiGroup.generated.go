...
type EmojiGroupAccessor struct {
	_data             []EmojiGroup
	_dataEmojiGroupID map[json.Number]EmojiGroup
...
func (a *EmojiGroupAccessor) GroupData() {
	a._dataEmojiGroupID = map[json.Number]EmojiGroup{}
	a._dataImgPath = map[string]EmojiGroup{}
...
func (a *EmojiGroupAccessor) ByEmojiGroupID(identifier json.Number) (EmojiGroup, error) {
