...
type RogueTournTitanTalentAccessor struct {
	...
	_dataID      map[json.Number]RogueTournTitanTalent
}
...
func (a *RogueTournTitanTalentAccessor) GroupData() {
	...
	a._dataID = map[json.Number]RogueTournTitanTalent{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueTournTitanTalentAccessor) ByID(identifier json.Number) (RogueTournTitanTalent, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
