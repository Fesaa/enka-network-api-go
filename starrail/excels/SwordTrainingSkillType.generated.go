...
type SwordTrainingSkillTypeAccessor struct {
	...
	_dataSkillTypeID   map[json.Number]SwordTrainingSkillType
	_dataSkillTypeIcon map[string]SwordTrainingSkillType
	_dataStatusID      map[json.Number]SwordTrainingSkillType
}
...
func (a *SwordTrainingSkillTypeAccessor) GroupData() {
	a._dataSkillTypeID = map[json.Number]SwordTrainingSkillType{}
	a._dataSkillTypeIcon = map[string]SwordTrainingSkillType{}
	a._dataStatusID = map[json.Number]SwordTrainingSkillType{}
...
func (a *SwordTrainingSkillTypeAccessor) BySkillTypeID(identifier json.Number) (SwordTrainingSkillType, error) {
...
//
// Error is only non-nil if the source errors out
func (a *SwordTrainingSkillTypeAccessor) ByStatusID(identifier json.Number) (SwordTrainingSkillType, error) {
