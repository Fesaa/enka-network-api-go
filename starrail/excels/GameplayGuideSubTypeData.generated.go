...
type GameplayGuideSubTypeDataAccessor struct {
	...
	_dataSubTypeID   map[json.Number]GameplayGuideSubTypeData
...
func (a *GameplayGuideSubTypeDataAccessor) GroupData() {
	a._dataSubTypeID = map[json.Number]GameplayGuideSubTypeData{}
...
func (a *GameplayGuideSubTypeDataAccessor) BySubTypeID(identifier json.Number) (GameplayGuideSubTypeData, error) {
