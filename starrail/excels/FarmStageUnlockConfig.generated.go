...
type FarmStageUnlockConfigAccessor struct {
	...
	_dataID               map[json.Number]FarmStageUnlockConfig
...
func (a *FarmStageUnlockConfigAccessor) GroupData() {
	a._dataID = map[json.Number]FarmStageUnlockConfig{}
...
func (a *FarmStageUnlockConfigAccessor) ByID(identifier json.Number) (FarmStageUnlockConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
