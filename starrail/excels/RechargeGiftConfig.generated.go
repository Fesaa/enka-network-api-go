...
type RechargeGiftConfigAccessor struct {
	...
	_dataDiscount map[json.Number]RechargeGiftConfig
	_dataGiftType map[json.Number]RechargeGiftConfig
}
...
func (a *RechargeGiftConfigAccessor) GroupData() {
	a._dataDiscount = map[json.Number]RechargeGiftConfig{}
	a._dataGiftType = map[json.Number]RechargeGiftConfig{}
...
func (a *RechargeGiftConfigAccessor) ByDiscount(identifier json.Number) (RechargeGiftConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *RechargeGiftConfigAccessor) ByGiftType(identifier json.Number) (RechargeGiftConfig, error) {
