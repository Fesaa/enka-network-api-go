...
type RogueDLCDiceSurfaceRarityAccessor struct {
	...
	_dataRarity                 map[json.Number]RogueDLCDiceSurfaceRarity
}
...
func (a *RogueDLCDiceSurfaceRarityAccessor) GroupData() {
	...
	a._dataRarity = map[json.Number]RogueDLCDiceSurfaceRarity{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueDLCDiceSurfaceRarityAccessor) ByRarity(identifier json.Number) (RogueDLCDiceSurfaceRarity, error) {
