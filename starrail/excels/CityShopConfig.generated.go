...
type CityShopConfigAccessor struct {
	...
	_dataItemID            map[json.Number]CityShopConfig
	_dataMaxLevel          map[json.Number]CityShopConfig
	_dataRewardListGroupID map[json.Number]CityShopConfig
	_dataShopID            map[json.Number]CityShopConfig
	_dataWorldID           map[json.Number]CityShopConfig
...
func (a *CityShopConfigAccessor) GroupData() {
	a._dataItemID = map[json.Number]CityShopConfig{}
	a._dataMaxLevel = map[json.Number]CityShopConfig{}
	a._dataRewardListGroupID = map[json.Number]CityShopConfig{}
	a._dataShopID = map[json.Number]CityShopConfig{}
	a._dataWorldID = map[json.Number]CityShopConfig{}
...
func (a *CityShopConfigAccessor) ByItemID(identifier json.Number) (CityShopConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *CityShopConfigAccessor) ByMaxLevel(identifier json.Number) (CityShopConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *CityShopConfigAccessor) ByRewardListGroupID(identifier json.Number) (CityShopConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *CityShopConfigAccessor) ByShopID(identifier json.Number) (CityShopConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *CityShopConfigAccessor) ByWorldID(identifier json.Number) (CityShopConfig, error) {
