...
type RogueTournGambleGroupAccessor struct {
	...
	_dataGambleGroupID map[json.Number]RogueTournGambleGroup
}
...
func (a *RogueTournGambleGroupAccessor) GroupData() {
	a._dataGambleGroupID = map[json.Number]RogueTournGambleGroup{}
...
func (a *RogueTournGambleGroupAccessor) ByGambleGroupID(identifier json.Number) (RogueTournGambleGroup, error) {
