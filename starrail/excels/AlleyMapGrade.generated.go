...
type AlleyMapGradeAccessor struct {
	_data          []AlleyMapGrade
	_dataGradeID   map[json.Number]AlleyMapGrade
...
func (a *AlleyMapGradeAccessor) GroupData() {
	a._dataGradeID = map[json.Number]AlleyMapGrade{}
...
func (a *AlleyMapGradeAccessor) ByGradeID(identifier json.Number) (AlleyMapGrade, error) {
