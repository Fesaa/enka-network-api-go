...
type TrainPartyWorkingBuffConfigAccessor struct {
	...
	_dataWorkingBuffID map[json.Number]TrainPartyWorkingBuffConfig
}
...
func (a *TrainPartyWorkingBuffConfigAccessor) GroupData() {
	...
	a._dataWorkingBuffID = map[json.Number]TrainPartyWorkingBuffConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *TrainPartyWorkingBuffConfigAccessor) ByWorkingBuffID(identifier json.Number) (TrainPartyWorkingBuffConfig, error) {
