...
type PlanetFesEventAccessor struct {
	...
	_dataInitialAppearCD map[json.Number]PlanetFesEvent
}
...
func (a *PlanetFesEventAccessor) GroupData() {
	...
	a._dataInitialAppearCD = map[json.Number]PlanetFesEvent{}
...
//
// Error is only non-nil if the source errors out
func (a *PlanetFesEventAccessor) ByInitialAppearCD(identifier json.Number) (PlanetFesEvent, error) {
