...
type MatchThreeRobotDBAccessor struct {
	...
	_dataRobotID map[json.Number]MatchThreeRobotDB
}
...
func (a *MatchThreeRobotDBAccessor) GroupData() {
	a._dataRobotID = map[json.Number]MatchThreeRobotDB{}
...
func (a *MatchThreeRobotDBAccessor) ByRobotID(identifier json.Number) (MatchThreeRobotDB, error) {
