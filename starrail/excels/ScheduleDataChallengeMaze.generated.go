...
type ScheduleDataChallengeMazeAccessor struct {
	...
	_dataID        map[json.Number]ScheduleDataChallengeMaze
}
...
func (a *ScheduleDataChallengeMazeAccessor) GroupData() {
	...
	a._dataID = map[json.Number]ScheduleDataChallengeMaze{}
...
//
// Error is only non-nil if the source errors out
func (a *ScheduleDataChallengeMazeAccessor) ByID(identifier json.Number) (ScheduleDataChallengeMaze, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
