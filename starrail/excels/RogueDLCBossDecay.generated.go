...
type RogueDLCBossDecayAccessor struct {
	...
	_dataBossDecayID map[json.Number]RogueDLCBossDecay
}
...
func (a *RogueDLCBossDecayAccessor) GroupData() {
	a._dataBossDecayID = map[json.Number]RogueDLCBossDecay{}
...
func (a *RogueDLCBossDecayAccessor) ByBossDecayID(identifier json.Number) (RogueDLCBossDecay, error) {
