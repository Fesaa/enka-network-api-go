...
type BoxingBreakBuffSelectConfigAccessor struct {
	...
	_dataBoxingClubBuffID map[json.Number]BoxingBreakBuffSelectConfig
}
...
func (a *BoxingBreakBuffSelectConfigAccessor) GroupData() {
	a._dataBoxingClubBuffID = map[json.Number]BoxingBreakBuffSelectConfig{}
...
func (a *BoxingBreakBuffSelectConfigAccessor) ByBoxingClubBuffID(identifier json.Number) (BoxingBreakBuffSelectConfig, error) {
