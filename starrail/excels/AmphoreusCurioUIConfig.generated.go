...
type AmphoreusCurioUIConfigAccessor struct {
	...
	_dataID       map[json.Number]AmphoreusCurioUIConfig
...
func (a *AmphoreusCurioUIConfigAccessor) GroupData() {
	a._dataID = map[json.Number]AmphoreusCurioUIConfig{}
...
func (a *AmphoreusCurioUIConfigAccessor) ByID(identifier json.Number) (AmphoreusCurioUIConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
