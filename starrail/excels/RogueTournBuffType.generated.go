...
type RogueTournBuffType struct {
	...
	RogueBuffTypeName      map[string]json.Number `json:"RogueBuffTypeName"`
...
type RogueTournBuffTypeAccessor struct {
	...
	_dataRogueBuffType          map[json.Number]RogueTournBuffType
...
func (a *RogueTournBuffTypeAccessor) GroupData() {
	a._dataRogueBuffType = map[json.Number]RogueTournBuffType{}
...
func (a *RogueTournBuffTypeAccessor) ByRogueBuffType(identifier json.Number) (RogueTournBuffType, error) {
