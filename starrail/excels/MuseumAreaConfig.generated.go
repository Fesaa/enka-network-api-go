...
type MuseumAreaConfigAccessor struct {
	...
	_dataAreaID             map[json.Number]MuseumAreaConfig
...
func (a *MuseumAreaConfigAccessor) GroupData() {
	a._dataAreaID = map[json.Number]MuseumAreaConfig{}
...
func (a *MuseumAreaConfigAccessor) ByAreaID(identifier json.Number) (MuseumAreaConfig, error) {
