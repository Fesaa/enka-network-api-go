...
type MonopolyAreaAssetConfigAccessor struct {
	...
	_dataID         map[json.Number]MonopolyAreaAssetConfig
}
...
func (a *MonopolyAreaAssetConfigAccessor) GroupData() {
	...
	a._dataID = map[json.Number]MonopolyAreaAssetConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *MonopolyAreaAssetConfigAccessor) ByID(identifier json.Number) (MonopolyAreaAssetConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
