...
type RogueRoomTypeAccessor struct {
	_data              []RogueRoomType
	_dataRogueRoomType map[json.Number]RogueRoomType
}
...
func (a *RogueRoomTypeAccessor) GroupData() {
	a._dataRogueRoomType = map[json.Number]RogueRoomType{}
...
func (a *RogueRoomTypeAccessor) ByRogueRoomType(identifier json.Number) (RogueRoomType, error) {
