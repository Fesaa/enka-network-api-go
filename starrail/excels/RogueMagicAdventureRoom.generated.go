...
type RogueMagicAdventureRoomAccessor struct {
	...
	_dataRoomID map[json.Number]RogueMagicAdventureRoom
}
...
func (a *RogueMagicAdventureRoomAccessor) GroupData() {
	a._dataRoomID = map[json.Number]RogueMagicAdventureRoom{}
...
func (a *RogueMagicAdventureRoomAccessor) ByRoomID(identifier json.Number) (RogueMagicAdventureRoom, error) {
