...
type NounAtlasChangeInfoAccessor struct {
	...
	_dataNounID map[json.Number]NounAtlasChangeInfo
}
...
func (a *NounAtlasChangeInfoAccessor) GroupData() {
	a._dataNounID = map[json.Number]NounAtlasChangeInfo{}
...
func (a *NounAtlasChangeInfoAccessor) ByNounID(identifier json.Number) (NounAtlasChangeInfo, error) {
