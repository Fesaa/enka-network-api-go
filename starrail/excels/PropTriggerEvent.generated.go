...
type PropTriggerEventAccessor struct {
	...
	_dataID           map[json.Number]PropTriggerEvent
...
func (a *PropTriggerEventAccessor) GroupData() {
	...
	a._dataID = map[json.Number]PropTriggerEvent{}
...
//
// Error is only non-nil if the source errors out
func (a *PropTriggerEventAccessor) ByID(identifier json.Number) (PropTriggerEvent, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
