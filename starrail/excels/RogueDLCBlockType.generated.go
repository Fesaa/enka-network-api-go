...
type RogueDLCBlockTypeAccessor struct {
	...
	_dataBlockTypeID             map[json.Number]RogueDLCBlockType
...
func (a *RogueDLCBlockTypeAccessor) GroupData() {
	...
	a._dataBlockTypeID = map[json.Number]RogueDLCBlockType{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueDLCBlockTypeAccessor) ByBlockTypeID(identifier json.Number) (RogueDLCBlockType, error) {
