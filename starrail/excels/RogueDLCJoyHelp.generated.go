...
type RogueDLCJoyHelpAccessor struct {
	...
	_dataAeonDimensionID map[json.Number]RogueDLCJoyHelp
}
...
func (a *RogueDLCJoyHelpAccessor) GroupData() {
	a._dataAeonDimensionID = map[json.Number]RogueDLCJoyHelp{}
...
func (a *RogueDLCJoyHelpAccessor) ByAeonDimensionID(identifier json.Number) (RogueDLCJoyHelp, error) {
