...
type ActivityScoreTypePunkLordAccessor struct {
	...
	_dataFinishPoint map[json.Number]ActivityScoreTypePunkLord
}
...
func (a *ActivityScoreTypePunkLordAccessor) GroupData() {
	a._dataFinishPoint = map[json.Number]ActivityScoreTypePunkLord{}
...
func (a *ActivityScoreTypePunkLordAccessor) ByFinishPoint(identifier json.Number) (ActivityScoreTypePunkLord, error) {
