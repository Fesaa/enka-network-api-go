...
type ModelIconConfigAccessor struct {
	...
	_dataID         map[json.Number]ModelIconConfig
...
func (a *ModelIconConfigAccessor) GroupData() {
	a._dataID = map[json.Number]ModelIconConfig{}
...
func (a *ModelIconConfigAccessor) ByID(identifier json.Number) (ModelIconConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
