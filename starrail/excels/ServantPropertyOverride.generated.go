...
type ServantPropertyOverrideAccessor struct {
	...
	_dataServantID map[json.Number]ServantPropertyOverride
}
...
func (a *ServantPropertyOverrideAccessor) GroupData() {
	a._dataServantID = map[json.Number]ServantPropertyOverride{}
...
func (a *ServantPropertyOverrideAccessor) ByServantID(identifier json.Number) (ServantPropertyOverride, error) {
