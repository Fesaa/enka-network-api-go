...
type StageBattleEventConfigAccessor struct {
	...
	_dataEventID map[json.Number]StageBattleEventConfig
}
...
func (a *StageBattleEventConfigAccessor) GroupData() {
	a._dataEventID = map[json.Number]StageBattleEventConfig{}
...
func (a *StageBattleEventConfigAccessor) ByEventID(identifier json.Number) (StageBattleEventConfig, error) {
