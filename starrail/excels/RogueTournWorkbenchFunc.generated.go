...
type RogueTournWorkbenchFuncAccessor struct {
	...
	_dataFuncID   map[json.Number]RogueTournWorkbenchFunc
...
func (a *RogueTournWorkbenchFuncAccessor) GroupData() {
	a._dataFuncID = map[json.Number]RogueTournWorkbenchFunc{}
...
func (a *RogueTournWorkbenchFuncAccessor) ByFuncID(identifier json.Number) (RogueTournWorkbenchFunc, error) {
