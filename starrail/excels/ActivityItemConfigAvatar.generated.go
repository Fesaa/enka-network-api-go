...
type ActivityItemConfigAvatarAccessor struct {
	...
	_dataID                 map[json.Number]ActivityItemConfigAvatar
...
func (a *ActivityItemConfigAvatarAccessor) GroupData() {
	a._dataID = map[json.Number]ActivityItemConfigAvatar{}
...
func (a *ActivityItemConfigAvatarAccessor) ByID(identifier json.Number) (ActivityItemConfigAvatar, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
