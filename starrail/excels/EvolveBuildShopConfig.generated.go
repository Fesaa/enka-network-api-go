...
type EvolveBuildShopConfigAccessor struct {
	...
	_dataID       map[json.Number]EvolveBuildShopConfig
...
func (a *EvolveBuildShopConfigAccessor) GroupData() {
	a._dataID = map[json.Number]EvolveBuildShopConfig{}
...
func (a *EvolveBuildShopConfigAccessor) ByID(identifier json.Number) (EvolveBuildShopConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
