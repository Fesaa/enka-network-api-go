...
type BattlePassRewardAccessor struct {
	...
	_dataID map[json.Number]BattlePassReward
}
...
func (a *BattlePassRewardAccessor) GroupData() {
	a._dataID = map[json.Number]BattlePassReward{}
...
func (a *BattlePassRewardAccessor) ByID(identifier json.Number) (BattlePassReward, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
