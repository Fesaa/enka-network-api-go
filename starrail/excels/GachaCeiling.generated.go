...
type GachaCeilingAccessor struct {
	_data            []GachaCeiling
	_dataCeilingNum  map[json.Number]GachaCeiling
...
func (a *GachaCeilingAccessor) GroupData() {
	a._dataCeilingNum = map[json.Number]GachaCeiling{}
...
func (a *GachaCeilingAccessor) ByCeilingNum(identifier json.Number) (GachaCeiling, error) {
