...
type ItemUseDataAccessor struct {
	_data          []ItemUseData
	_dataUseDataID map[json.Number]ItemUseData
}
...
func (a *ItemUseDataAccessor) GroupData() {
	a._dataUseDataID = map[json.Number]ItemUseData{}
...
func (a *ItemUseDataAccessor) ByUseDataID(identifier json.Number) (ItemUseData, error) {
