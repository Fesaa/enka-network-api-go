...
type RogueTournCollectionAccessor struct {
	...
	_dataCollectionID map[json.Number]RogueTournCollection
	_dataIconPath     map[string]RogueTournCollection
	_dataPrefabPath   map[string]RogueTournCollection
	_dataUnlockID     map[json.Number]RogueTournCollection
}
...
func (a *RogueTournCollectionAccessor) GroupData() {
	a._dataCollectionID = map[json.Number]RogueTournCollection{}
	a._dataIconPath = map[string]RogueTournCollection{}
	a._dataPrefabPath = map[string]RogueTournCollection{}
	a._dataUnlockID = map[json.Number]RogueTournCollection{}
...
func (a *RogueTournCollectionAccessor) ByCollectionID(identifier json.Number) (RogueTournCollection, error) {
...
//
// Error is only non-nil if the source errors out
func (a *RogueTournCollectionAccessor) ByUnlockID(identifier json.Number) (RogueTournCollection, error) {
