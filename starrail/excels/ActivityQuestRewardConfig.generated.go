...
type ActivityQuestRewardConfigAccessor struct {
	...
	_dataActivityModule   map[json.Number]ActivityQuestRewardConfig
	_dataActivityRewardID map[json.Number]ActivityQuestRewardConfig
}
...
func (a *ActivityQuestRewardConfigAccessor) GroupData() {
	a._dataActivityModule = map[json.Number]ActivityQuestRewardConfig{}
	a._dataActivityRewardID = map[json.Number]ActivityQuestRewardConfig{}
...
func (a *ActivityQuestRewardConfigAccessor) ByActivityModule(identifier json.Number) (ActivityQuestRewardConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *ActivityQuestRewardConfigAccessor) ByActivityRewardID(identifier json.Number) (ActivityQuestRewardConfig, error) {
