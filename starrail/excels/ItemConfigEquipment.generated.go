...
type ItemConfigEquipmentAccessor struct {
	...
	_dataID                 map[json.Number]ItemConfigEquipment
...
func (a *ItemConfigEquipmentAccessor) GroupData() {
	a._dataID = map[json.Number]ItemConfigEquipment{}
...
func (a *ItemConfigEquipmentAccessor) ByID(identifier json.Number) (ItemConfigEquipment, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
