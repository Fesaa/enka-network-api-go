...
type TrainPartyGridSpecialShowAccessor struct {
	...
	_dataGridID                   map[json.Number]TrainPartyGridSpecialShow
...
func (a *TrainPartyGridSpecialShowAccessor) GroupData() {
	a._dataGridID = map[json.Number]TrainPartyGridSpecialShow{}
...
func (a *TrainPartyGridSpecialShowAccessor) ByGridID(identifier json.Number) (TrainPartyGridSpecialShow, error) {
