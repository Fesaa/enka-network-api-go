...
type RogueNousSurfaceTagAccessor struct {
	...
	_dataSort  map[json.Number]RogueNousSurfaceTag
	_dataTagID map[json.Number]RogueNousSurfaceTag
}
...
func (a *RogueNousSurfaceTagAccessor) GroupData() {
	a._dataSort = map[json.Number]RogueNousSurfaceTag{}
	a._dataTagID = map[json.Number]RogueNousSurfaceTag{}
...
func (a *RogueNousSurfaceTagAccessor) BySort(identifier json.Number) (RogueNousSurfaceTag, error) {
	if a._dataSort == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
...
//
// Error is only non-nil if the source errors out
func (a *RogueNousSurfaceTagAccessor) ByTagID(identifier json.Number) (RogueNousSurfaceTag, error) {
	if a._dataTagID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
