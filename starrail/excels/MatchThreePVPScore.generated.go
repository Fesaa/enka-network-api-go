...
type MatchThreePVPScoreAccessor struct {
	...
	_dataScoreID map[json.Number]MatchThreePVPScore
}
...
func (a *MatchThreePVPScoreAccessor) GroupData() {
	a._dataScoreID = map[json.Number]MatchThreePVPScore{}
...
func (a *MatchThreePVPScoreAccessor) ByScoreID(identifier json.Number) (MatchThreePVPScore, error) {
