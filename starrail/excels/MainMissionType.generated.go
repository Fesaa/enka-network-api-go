...
type MainMissionType struct {
	IconMapConnect   float64   `json:"IconMapConnect"`
	IconMapOptional  float64   `json:"IconMapOptional"`
	IconMapStarted   float64   `json:"IconMapStarted"`
	IconMapToTake    float64   `json:"IconMapToTake"`
	...
	TypeName         hash.Hash `json:"TypeName"`
	TypePriority     float64   `json:"TypePriority"`
	WaypointIconType float64   `json:"WaypointIconType"`
}
