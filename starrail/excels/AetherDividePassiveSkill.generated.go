...
type AetherDividePassiveSkillAccessor struct {
	...
	_dataItemID                  map[json.Number]AetherDividePassiveSkill
...
func (a *AetherDividePassiveSkillAccessor) GroupData() {
	...
	a._dataItemID = map[json.Number]AetherDividePassiveSkill{}
...
//
// Error is only non-nil if the source errors out
func (a *AetherDividePassiveSkillAccessor) ByItemID(identifier json.Number) (AetherDividePassiveSkill, error) {
