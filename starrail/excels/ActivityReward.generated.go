...
type ActivityRewardAccessor struct {
	...
	_dataActivityRewardID map[json.Number]ActivityReward
	_dataCount            map[json.Number]ActivityReward
}
...
func (a *ActivityRewardAccessor) GroupData() {
	a._dataActivityRewardID = map[json.Number]ActivityReward{}
	a._dataCount = map[json.Number]ActivityReward{}
...
func (a *ActivityRewardAccessor) ByActivityRewardID(identifier json.Number) (ActivityReward, error) {
...
//
// Error is only non-nil if the source errors out
func (a *ActivityRewardAccessor) ByCount(identifier json.Number) (ActivityReward, error) {
	if a._dataCount == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
