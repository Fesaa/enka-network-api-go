...
type FinishWayRogueAccessor struct {
	...
	_dataID map[json.Number]FinishWayRogue
}
...
func (a *FinishWayRogueAccessor) GroupData() {
	a._dataID = map[json.Number]FinishWayRogue{}
...
func (a *FinishWayRogueAccessor) ByID(identifier json.Number) (FinishWayRogue, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
