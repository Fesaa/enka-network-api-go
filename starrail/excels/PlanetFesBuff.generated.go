...
type PlanetFesBuffAccessor struct {
	_data   []PlanetFesBuff
	_dataID map[json.Number]PlanetFesBuff
}
...
func (a *PlanetFesBuffAccessor) GroupData() {
	a._dataID = map[json.Number]PlanetFesBuff{}
...
func (a *PlanetFesBuffAccessor) ByID(identifier json.Number) (PlanetFesBuff, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
