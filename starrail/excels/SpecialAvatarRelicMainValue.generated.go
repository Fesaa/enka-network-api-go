...
type SpecialAvatarRelicMainValueAccessor struct {
	...
	_dataRelicMainValueType map[json.Number]SpecialAvatarRelicMainValue
}
...
func (a *SpecialAvatarRelicMainValueAccessor) GroupData() {
	a._dataRelicMainValueType = map[json.Number]SpecialAvatarRelicMainValue{}
...
func (a *SpecialAvatarRelicMainValueAccessor) ByRelicMainValueType(identifier json.Number) (SpecialAvatarRelicMainValue, error) {
