...
type FreeStyleMotionAccessor struct {
	...
	_dataID map[json.Number]FreeStyleMotion
}
...
func (a *FreeStyleMotionAccessor) GroupData() {
	a._dataID = map[json.Number]FreeStyleMotion{}
...
func (a *FreeStyleMotionAccessor) ByID(identifier json.Number) (FreeStyleMotion, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
