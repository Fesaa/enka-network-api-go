...
type TrainPartyDynamicConfigAccessor struct {
	...
	_dataID         map[json.Number]TrainPartyDynamicConfig
...
func (a *TrainPartyDynamicConfigAccessor) GroupData() {
	a._dataID = map[json.Number]TrainPartyDynamicConfig{}
...
func (a *TrainPartyDynamicConfigAccessor) ByID(identifier json.Number) (TrainPartyDynamicConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
