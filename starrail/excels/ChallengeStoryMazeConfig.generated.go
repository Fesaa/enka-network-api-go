...
type ChallengeStoryMazeConfigAccessor struct {
	...
	_dataID map[json.Number]ChallengeStoryMazeConfig
}
...
func (a *ChallengeStoryMazeConfigAccessor) GroupData() {
	a._dataID = map[json.Number]ChallengeStoryMazeConfig{}
...
func (a *ChallengeStoryMazeConfigAccessor) ByID(identifier json.Number) (ChallengeStoryMazeConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
