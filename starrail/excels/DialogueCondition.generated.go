...
type DialogueConditionAccessor struct {
	...
	_dataID map[json.Number]DialogueCondition
}
...
func (a *DialogueConditionAccessor) GroupData() {
	a._dataID = map[json.Number]DialogueCondition{}
...
func (a *DialogueConditionAccessor) ByID(identifier json.Number) (DialogueCondition, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
