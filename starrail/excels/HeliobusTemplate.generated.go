...
type HeliobusTemplateAccessor struct {
	...
	_dataHeliobusTemplateID map[json.Number]HeliobusTemplate
...
func (a *HeliobusTemplateAccessor) GroupData() {
	a._dataHeliobusTemplateID = map[json.Number]HeliobusTemplate{}
...
func (a *HeliobusTemplateAccessor) ByHeliobusTemplateID(identifier json.Number) (HeliobusTemplate, error) {
