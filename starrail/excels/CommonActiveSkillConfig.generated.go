...
type CommonActiveSkillConfigAccessor struct {
	...
	_dataCommonActiveSkillID map[json.Number]CommonActiveSkillConfig
}
...
func (a *CommonActiveSkillConfigAccessor) GroupData() {
	a._dataCommonActiveSkillID = map[json.Number]CommonActiveSkillConfig{}
...
func (a *CommonActiveSkillConfigAccessor) ByCommonActiveSkillID(identifier json.Number) (CommonActiveSkillConfig, error) {
