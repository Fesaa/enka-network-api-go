...
type RogueTournDifficultyAccessor struct {
	...
	_dataDifficultyID map[json.Number]RogueTournDifficulty
}
...
func (a *RogueTournDifficultyAccessor) GroupData() {
	a._dataDifficultyID = map[json.Number]RogueTournDifficulty{}
...
func (a *RogueTournDifficultyAccessor) ByDifficultyID(identifier json.Number) (RogueTournDifficulty, error) {
