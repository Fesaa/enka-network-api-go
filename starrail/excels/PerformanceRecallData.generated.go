...
type PerformanceRecallDataAccessor struct {
	...
	_dataID map[json.Number]PerformanceRecallData
}
...
func (a *PerformanceRecallDataAccessor) GroupData() {
	a._dataID = map[json.Number]PerformanceRecallData{}
...
func (a *PerformanceRecallDataAccessor) ByID(identifier json.Number) (PerformanceRecallData, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
