...
type RogueTournFormulaAeonIconAccessor struct {
	...
	_dataBuffTypeID           map[json.Number]RogueTournFormulaAeonIcon
...
func (a *RogueTournFormulaAeonIconAccessor) GroupData() {
	a._dataBuffTypeID = map[json.Number]RogueTournFormulaAeonIcon{}
...
func (a *RogueTournFormulaAeonIconAccessor) ByBuffTypeID(identifier json.Number) (RogueTournFormulaAeonIcon, error) {
