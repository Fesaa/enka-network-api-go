...
type RogueWolfGunMiracleTargetAccessor struct {
	...
	_dataMiracleID map[json.Number]RogueWolfGunMiracleTarget
}
...
func (a *RogueWolfGunMiracleTargetAccessor) GroupData() {
	a._dataMiracleID = map[json.Number]RogueWolfGunMiracleTarget{}
...
func (a *RogueWolfGunMiracleTargetAccessor) ByMiracleID(identifier json.Number) (RogueWolfGunMiracleTarget, error) {
