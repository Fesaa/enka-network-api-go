...
type MonopolyEventOptionAccessor struct {
	...
	_dataEventOptionID map[json.Number]MonopolyEventOption
}
...
func (a *MonopolyEventOptionAccessor) GroupData() {
	a._dataEventOptionID = map[json.Number]MonopolyEventOption{}
...
func (a *MonopolyEventOptionAccessor) ByEventOptionID(identifier json.Number) (MonopolyEventOption, error) {
