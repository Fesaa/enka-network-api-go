...
type ChimeraMotionAccessor struct {
	_data          []ChimeraMotion
	_dataMotionID  map[json.Number]ChimeraMotion
...
func (a *ChimeraMotionAccessor) GroupData() {
	a._dataMotionID = map[json.Number]ChimeraMotion{}
...
func (a *ChimeraMotionAccessor) ByMotionID(identifier json.Number) (ChimeraMotion, error) {
