...
type RogueTournNPCAccessor struct {
	...
	_dataRogueNPCID  map[json.Number]RogueTournNPC
}
...
func (a *RogueTournNPCAccessor) GroupData() {
	...
	a._dataRogueNPCID = map[json.Number]RogueTournNPC{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueTournNPCAccessor) ByRogueNPCID(identifier json.Number) (RogueTournNPC, error) {
