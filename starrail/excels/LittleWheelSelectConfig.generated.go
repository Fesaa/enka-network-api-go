...
type LittleWheelSelectConfig struct {
	...
	Left1    []float64     `json:"Left1"`
	Left2    []float64     `json:"Left2"`
	Left3    []float64     `json:"Left3"`
	Left4    []float64     `json:"Left4"`
	Right1   []float64     `json:"Right1"`
	Right2   []float64     `json:"Right2"`
	Right3   []float64     `json:"Right3"`
