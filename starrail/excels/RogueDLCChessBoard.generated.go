...
type RogueDLCChessBoardAccessor struct {
	...
	_dataChessBoardID map[json.Number]RogueDLCChessBoard
}
...
func (a *RogueDLCChessBoardAccessor) GroupData() {
	a._dataChessBoardID = map[json.Number]RogueDLCChessBoard{}
...
func (a *RogueDLCChessBoardAccessor) ByChessBoardID(identifier json.Number) (RogueDLCChessBoard, error) {
