...
type ActivityRaidCollectionQuestAccessor struct {
	...
	_dataQuestTabID map[json.Number]ActivityRaidCollectionQuest
}
...
func (a *ActivityRaidCollectionQuestAccessor) GroupData() {
	a._dataQuestTabID = map[json.Number]ActivityRaidCollectionQuest{}
...
func (a *ActivityRaidCollectionQuestAccessor) ByQuestTabID(identifier json.Number) (ActivityRaidCollectionQuest, error) {
