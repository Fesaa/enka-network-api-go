...
type AudioBookDataAccessor struct {
	...
	_dataBookID     map[json.Number]AudioBookData
}
...
func (a *AudioBookDataAccessor) GroupData() {
	...
	a._dataBookID = map[json.Number]AudioBookData{}
...
//
// Error is only non-nil if the source errors out
func (a *AudioBookDataAccessor) ByBookID(identifier json.Number) (AudioBookData, error) {
