...
type HeliobusPostImgAccessor struct {
	...
	_dataPostImgID   map[json.Number]HeliobusPostImg
...
func (a *HeliobusPostImgAccessor) GroupData() {
	a._dataPostImgID = map[json.Number]HeliobusPostImg{}
...
func (a *HeliobusPostImgAccessor) ByPostImgID(identifier json.Number) (HeliobusPostImg, error) {
