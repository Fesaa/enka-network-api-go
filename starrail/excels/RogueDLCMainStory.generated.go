...
type RogueDLCMainStoryAccessor struct {
	...
	_dataMainStoryID         map[json.Number]RogueDLCMainStory
}
...
func (a *RogueDLCMainStoryAccessor) GroupData() {
	...
	a._dataMainStoryID = map[json.Number]RogueDLCMainStory{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueDLCMainStoryAccessor) ByMainStoryID(identifier json.Number) (RogueDLCMainStory, error) {
