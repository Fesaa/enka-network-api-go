...
type MaterialSubmitterGroupAccessor struct {
	...
	_dataActivityID map[json.Number]MaterialSubmitterGroup
...
func (a *MaterialSubmitterGroupAccessor) GroupData() {
	a._dataActivityID = map[json.Number]MaterialSubmitterGroup{}
...
func (a *MaterialSubmitterGroupAccessor) ByActivityID(identifier json.Number) (MaterialSubmitterGroup, error) {
