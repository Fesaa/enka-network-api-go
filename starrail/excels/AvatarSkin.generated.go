...
type AvatarSkin struct {
	...
	AvatarSkinName                     map[string]json.Number `json:"AvatarSkinName"`
	...
	PlayerCardID                       json.Number            `json:"PlayerCardID"`
...
type AvatarSkinAccessor struct {
	...
	_dataAvatarID                           map[json.Number]AvatarSkin
	...
	_dataID                                 map[json.Number]AvatarSkin
	_dataPlayerCardID                       map[json.Number]AvatarSkin
...
func (a *AvatarSkinAccessor) GroupData() {
	...
	a._dataAvatarID = map[json.Number]AvatarSkin{}
	...
	a._dataID = map[json.Number]AvatarSkin{}
	a._dataPlayerCardID = map[json.Number]AvatarSkin{}
...
//
// Error is only non-nil if the source errors out
func (a *AvatarSkinAccessor) ByAvatarID(identifier json.Number) (AvatarSkin, error) {
...
//
// Error is only non-nil if the source errors out
func (a *AvatarSkinAccessor) ByID(identifier json.Number) (AvatarSkin, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
...
//
// Error is only non-nil if the source errors out
func (a *AvatarSkinAccessor) ByPlayerCardID(identifier json.Number) (AvatarSkin, error) {
