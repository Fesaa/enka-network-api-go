...
type PlanetFesSkillTreePhaseAccessor struct {
	...
	_dataPhase map[json.Number]PlanetFesSkillTreePhase
}
...
func (a *PlanetFesSkillTreePhaseAccessor) GroupData() {
	a._dataPhase = map[json.Number]PlanetFesSkillTreePhase{}
...
func (a *PlanetFesSkillTreePhaseAccessor) ByPhase(identifier json.Number) (PlanetFesSkillTreePhase, error) {
	if a._dataPhase == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
