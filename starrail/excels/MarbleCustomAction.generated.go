...
type MarbleCustomActionAccessor struct {
	...
	_dataID        map[json.Number]MarbleCustomAction
	_dataSealInsID map[json.Number]MarbleCustomAction
}
...
func (a *MarbleCustomActionAccessor) GroupData() {
	a._dataID = map[json.Number]MarbleCustomAction{}
	a._dataSealInsID = map[json.Number]MarbleCustomAction{}
...
func (a *MarbleCustomActionAccessor) ByID(identifier json.Number) (MarbleCustomAction, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
...
//
// Error is only non-nil if the source errors out
func (a *MarbleCustomActionAccessor) BySealInsID(identifier json.Number) (MarbleCustomAction, error) {
