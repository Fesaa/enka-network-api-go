...
type FunctionHudSpecialAccessor struct {
	...
	_dataID             map[json.Number]FunctionHudSpecial
}
...
func (a *FunctionHudSpecialAccessor) GroupData() {
	...
	a._dataID = map[json.Number]FunctionHudSpecial{}
...
//
// Error is only non-nil if the source errors out
func (a *FunctionHudSpecialAccessor) ByID(identifier json.Number) (FunctionHudSpecial, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
