...
type ActivityBannerComMission struct {
	...
	AvatarIDList      []json.Number          `json:"AvatarIDList"`
	BannerID          json.Number            `json:"BannerID"`
	MainImagePath     string                 `json:"MainImagePath"`
	MainMissionIDList []json.Number          `json:"MainMissionIDList"`
	ShortDesc         map[string]json.Number `json:"ShortDesc"`
	...
	UnlockMissionList []json.Number          `json:"UnlockMissionList"`
}
type ActivityBannerComMissionAccessor struct {
	_data              []ActivityBannerComMission
	_dataBannerID      map[json.Number]ActivityBannerComMission
...
func (a *ActivityBannerComMissionAccessor) GroupData() {
	a._dataBannerID = map[json.Number]ActivityBannerComMission{}
...
func (a *ActivityBannerComMissionAccessor) ByBannerID(identifier json.Number) (ActivityBannerComMission, error) {
