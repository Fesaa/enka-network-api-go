...
type ActivityPanelSevenDayRewardAccessor struct {
	...
	_dataID                 map[json.Number]ActivityPanelSevenDayReward
...
func (a *ActivityPanelSevenDayRewardAccessor) GroupData() {
	...
	a._dataID = map[json.Number]ActivityPanelSevenDayReward{}
...
//
// Error is only non-nil if the source errors out
func (a *ActivityPanelSevenDayRewardAccessor) ByID(identifier json.Number) (ActivityPanelSevenDayReward, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
