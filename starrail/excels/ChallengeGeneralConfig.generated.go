...
type ChallengeGeneralConfigAccessor struct {
	...
	_dataGotoID             map[json.Number]ChallengeGeneralConfig
...
func (a *ChallengeGeneralConfigAccessor) GroupData() {
	...
	a._dataGotoID = map[json.Number]ChallengeGeneralConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *ChallengeGeneralConfigAccessor) ByGotoID(identifier json.Number) (ChallengeGeneralConfig, error) {
