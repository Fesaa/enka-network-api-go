...
type PSTrophyGroupAccessor struct {
	_data              []PSTrophyGroup
	_dataPSTrophyGroup map[json.Number]PSTrophyGroup
}
...
func (a *PSTrophyGroupAccessor) GroupData() {
	a._dataPSTrophyGroup = map[json.Number]PSTrophyGroup{}
...
func (a *PSTrophyGroupAccessor) ByPSTrophyGroup(identifier json.Number) (PSTrophyGroup, error) {
