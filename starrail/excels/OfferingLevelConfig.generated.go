...
type OfferingLevelConfigAccessor struct {
	...
	_dataRewardID map[json.Number]OfferingLevelConfig
}
...
func (a *OfferingLevelConfigAccessor) GroupData() {
	a._dataRewardID = map[json.Number]OfferingLevelConfig{}
...
func (a *OfferingLevelConfigAccessor) ByRewardID(identifier json.Number) (OfferingLevelConfig, error) {
