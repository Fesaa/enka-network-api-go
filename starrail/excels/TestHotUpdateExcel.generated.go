...
type TestHotUpdateExcelAccessor struct {
	...
	_dataAvatarID   map[json.Number]TestHotUpdateExcel
...
func (a *TestHotUpdateExcelAccessor) GroupData() {
	a._dataAvatarID = map[json.Number]TestHotUpdateExcel{}
...
func (a *TestHotUpdateExcelAccessor) ByAvatarID(identifier json.Number) (TestHotUpdateExcel, error) {
