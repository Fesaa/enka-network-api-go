...
type SpecialMode struct {
	...
	PuzzleType    json.Number `json:"PuzzleType"`
...
type SpecialModeAccessor struct {
	...
	_dataSpecialModeID map[json.Number]SpecialMode
...
func (a *SpecialModeAccessor) GroupData() {
	...
	a._dataSpecialModeID = map[json.Number]SpecialMode{}
...
//
// Error is only non-nil if the source errors out
func (a *SpecialModeAccessor) BySpecialModeID(identifier json.Number) (SpecialMode, error) {
