...
type RogueTournExhibitionAccessor struct {
	...
	_dataExhibitionID   map[json.Number]RogueTournExhibition
	_dataIconPath       map[string]RogueTournExhibition
	_dataImagePath      map[string]RogueTournExhibition
	_dataProgramGroupID map[json.Number]RogueTournExhibition
...
func (a *RogueTournExhibitionAccessor) GroupData() {
	a._dataExhibitionID = map[json.Number]RogueTournExhibition{}
	a._dataIconPath = map[string]RogueTournExhibition{}
	a._dataImagePath = map[string]RogueTournExhibition{}
	a._dataProgramGroupID = map[json.Number]RogueTournExhibition{}
...
func (a *RogueTournExhibitionAccessor) ByExhibitionID(identifier json.Number) (RogueTournExhibition, error) {
...
//
// Error is only non-nil if the source errors out
func (a *RogueTournExhibitionAccessor) ByProgramGroupID(identifier json.Number) (RogueTournExhibition, error) {
