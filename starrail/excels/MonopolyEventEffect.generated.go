...
type MonopolyEventEffectAccessor struct {
	...
	_dataEffectID map[json.Number]MonopolyEventEffect
}
...
func (a *MonopolyEventEffectAccessor) GroupData() {
	a._dataEffectID = map[json.Number]MonopolyEventEffect{}
...
func (a *MonopolyEventEffectAccessor) ByEffectID(identifier json.Number) (MonopolyEventEffect, error) {
