...
type AlleySpecialOrderAccessor struct {
	...
	_dataSpecialOrderID     map[json.Number]AlleySpecialOrder
	_dataSpecialOrderShopID map[json.Number]AlleySpecialOrder
...
func (a *AlleySpecialOrderAccessor) GroupData() {
	...
	a._dataSpecialOrderID = map[json.Number]AlleySpecialOrder{}
	a._dataSpecialOrderShopID = map[json.Number]AlleySpecialOrder{}
...
//
// Error is only non-nil if the source errors out
func (a *AlleySpecialOrderAccessor) BySpecialOrderID(identifier json.Number) (AlleySpecialOrder, error) {
...
//
// Error is only non-nil if the source errors out
func (a *AlleySpecialOrderAccessor) BySpecialOrderShopID(identifier json.Number) (AlleySpecialOrder, error) {
