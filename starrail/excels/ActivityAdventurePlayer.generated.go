...
type ActivityAdventurePlayerAccessor struct {
	...
	_dataAvatarID                  map[json.Number]ActivityAdventurePlayer
	_dataDefaultAvatarHeadIconPath map[string]ActivityAdventurePlayer
	_dataID                        map[json.Number]ActivityAdventurePlayer
...
func (a *ActivityAdventurePlayerAccessor) GroupData() {
	a._dataAvatarID = map[json.Number]ActivityAdventurePlayer{}
	a._dataDefaultAvatarHeadIconPath = map[string]ActivityAdventurePlayer{}
	a._dataID = map[json.Number]ActivityAdventurePlayer{}
...
func (a *ActivityAdventurePlayerAccessor) ByAvatarID(identifier json.Number) (ActivityAdventurePlayer, error) {
...
//
// Error is only non-nil if the source errors out
func (a *ActivityAdventurePlayerAccessor) ByID(identifier json.Number) (ActivityAdventurePlayer, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
