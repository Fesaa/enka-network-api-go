...
type ItemConfigTrainDynamicAccessor struct {
	...
	_dataID                 map[json.Number]ItemConfigTrainDynamic
...
func (a *ItemConfigTrainDynamicAccessor) GroupData() {
	a._dataID = map[json.Number]ItemConfigTrainDynamic{}
...
func (a *ItemConfigTrainDynamicAccessor) ByID(identifier json.Number) (ItemConfigTrainDynamic, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
