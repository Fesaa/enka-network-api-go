...
type MonsterStatusConfigAccessor struct {
	...
	_dataStatusID     map[json.Number]MonsterStatusConfig
}
...
func (a *MonsterStatusConfigAccessor) GroupData() {
	...
	a._dataStatusID = map[json.Number]MonsterStatusConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *MonsterStatusConfigAccessor) ByStatusID(identifier json.Number) (MonsterStatusConfig, error) {
