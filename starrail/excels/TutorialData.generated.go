...
type TutorialDataAccessor struct {
	_data           []TutorialData
	_dataTutorialID map[json.Number]TutorialData
}
...
func (a *TutorialDataAccessor) GroupData() {
	a._dataTutorialID = map[json.Number]TutorialData{}
...
func (a *TutorialDataAccessor) ByTutorialID(identifier json.Number) (TutorialData, error) {
