...
type AllowedTextLanguage struct {
	...
	LanguageType               json.Number            `json:"LanguageType"`
...
func (a *AllowedTextLanguageAccessor) GroupData() {
	...
	a._dataLanguageType = map[json.Number]AllowedTextLanguage{}
...
//
// Error is only non-nil if the source errors out
func (a *AllowedTextLanguageAccessor) ByLanguageType(identifier json.Number) (AllowedTextLanguage, error) {
