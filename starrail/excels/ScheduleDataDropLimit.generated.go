...
type ScheduleDataDropLimitAccessor struct {
	...
	_dataID        map[json.Number]ScheduleDataDropLimit
}
...
func (a *ScheduleDataDropLimitAccessor) GroupData() {
	...
	a._dataID = map[json.Number]ScheduleDataDropLimit{}
...
//
// Error is only non-nil if the source errors out
func (a *ScheduleDataDropLimitAccessor) ByID(identifier json.Number) (ScheduleDataDropLimit, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
