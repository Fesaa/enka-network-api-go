...
type RogueDLCAeonDiceAccessor struct {
	...
	_dataAeonDiceID           map[json.Number]RogueDLCAeonDice
...
func (a *RogueDLCAeonDiceAccessor) GroupData() {
	a._dataAeonDiceID = map[json.Number]RogueDLCAeonDice{}
...
func (a *RogueDLCAeonDiceAccessor) ByAeonDiceID(identifier json.Number) (RogueDLCAeonDice, error) {
