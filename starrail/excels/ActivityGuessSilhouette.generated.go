...
type ActivityGuessSilhouetteAccessor struct {
	...
	_dataSilhouetteID       map[json.Number]ActivityGuessSilhouette
...
func (a *ActivityGuessSilhouetteAccessor) GroupData() {
	...
	a._dataSilhouetteID = map[json.Number]ActivityGuessSilhouette{}
...
//
// Error is only non-nil if the source errors out
func (a *ActivityGuessSilhouetteAccessor) BySilhouetteID(identifier json.Number) (ActivityGuessSilhouette, error) {
