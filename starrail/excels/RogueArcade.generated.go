...
type RogueArcadeAccessor struct {
	_data             []RogueArcade
	_dataArcadeRoomID map[json.Number]RogueArcade
}
...
func (a *RogueArcadeAccessor) GroupData() {
	a._dataArcadeRoomID = map[json.Number]RogueArcade{}
...
func (a *RogueArcadeAccessor) ByArcadeRoomID(identifier json.Number) (RogueArcade, error) {
