...
type Anniversary2NDTabConfigAccessor struct {
	...
	_dataTabID     map[json.Number]Anniversary2NDTabConfig
...
func (a *Anniversary2NDTabConfigAccessor) GroupData() {
	...
	a._dataTabID = map[json.Number]Anniversary2NDTabConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *Anniversary2NDTabConfigAccessor) ByTabID(identifier json.Number) (Anniversary2NDTabConfig, error) {
	if a._dataTabID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
