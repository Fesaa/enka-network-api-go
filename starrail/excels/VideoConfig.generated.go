...
type VideoConfigAccessor struct {
	_data          []VideoConfig
	_dataVideoID   map[json.Number]VideoConfig
...
func (a *VideoConfigAccessor) GroupData() {
	a._dataVideoID = map[json.Number]VideoConfig{}
...
func (a *VideoConfigAccessor) ByVideoID(identifier json.Number) (VideoConfig, error) {
