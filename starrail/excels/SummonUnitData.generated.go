...
type SummonUnitDataAccessor struct {
	...
	_dataID       map[json.Number]SummonUnitData
...
func (a *SummonUnitDataAccessor) GroupData() {
	a._dataID = map[json.Number]SummonUnitData{}
...
func (a *SummonUnitDataAccessor) ByID(identifier json.Number) (SummonUnitData, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
