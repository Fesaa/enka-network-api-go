...
type RndOptionsDataAccessor struct {
	...
	_dataID         map[json.Number]RndOptionsData
	_dataJsonPath   map[string]RndOptionsData
	_dataMenuItemID map[json.Number]RndOptionsData
}
...
func (a *RndOptionsDataAccessor) GroupData() {
	a._dataID = map[json.Number]RndOptionsData{}
	a._dataJsonPath = map[string]RndOptionsData{}
	a._dataMenuItemID = map[json.Number]RndOptionsData{}
...
func (a *RndOptionsDataAccessor) ByID(identifier json.Number) (RndOptionsData, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
...
//
// Error is only non-nil if the source errors out
func (a *RndOptionsDataAccessor) ByMenuItemID(identifier json.Number) (RndOptionsData, error) {
