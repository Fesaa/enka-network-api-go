...
type ItemConfigBookAccessor struct {
	...
	_dataID map[json.Number]ItemConfigBook
}
...
func (a *ItemConfigBookAccessor) GroupData() {
	a._dataID = map[json.Number]ItemConfigBook{}
...
func (a *ItemConfigBookAccessor) ByID(identifier json.Number) (ItemConfigBook, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
