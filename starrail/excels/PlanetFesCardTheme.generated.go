...
type PlanetFesCardThemeAccessor struct {
	...
	_dataThemeID  map[json.Number]PlanetFesCardTheme
}
...
func (a *PlanetFesCardThemeAccessor) GroupData() {
	...
	a._dataThemeID = map[json.Number]PlanetFesCardTheme{}
...
//
// Error is only non-nil if the source errors out
func (a *PlanetFesCardThemeAccessor) ByThemeID(identifier json.Number) (PlanetFesCardTheme, error) {
