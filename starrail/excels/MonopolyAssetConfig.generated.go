...
type MonopolyAssetConfigAccessor struct {
	...
	_dataAssetID    map[json.Number]MonopolyAssetConfig
...
func (a *MonopolyAssetConfigAccessor) GroupData() {
	a._dataAssetID = map[json.Number]MonopolyAssetConfig{}
...
func (a *MonopolyAssetConfigAccessor) ByAssetID(identifier json.Number) (MonopolyAssetConfig, error) {
