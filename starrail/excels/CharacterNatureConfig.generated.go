...
type CharacterNatureConfigAccessor struct {
	...
	_dataNatureID map[json.Number]CharacterNatureConfig
}
...
func (a *CharacterNatureConfigAccessor) GroupData() {
	a._dataNatureID = map[json.Number]CharacterNatureConfig{}
...
func (a *CharacterNatureConfigAccessor) ByNatureID(identifier json.Number) (CharacterNatureConfig, error) {
