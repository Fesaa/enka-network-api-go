...
type BattleEventSkillConfigAccessor struct {
	...
	_dataSkillID map[json.Number]BattleEventSkillConfig
}
...
func (a *BattleEventSkillConfigAccessor) GroupData() {
	a._dataSkillID = map[json.Number]BattleEventSkillConfig{}
...
func (a *BattleEventSkillConfigAccessor) BySkillID(identifier json.Number) (BattleEventSkillConfig, error) {
