...
type AlleyOrderAccessor struct {
	_data          []AlleyOrder
	_dataOrderID   map[json.Number]AlleyOrder
...
func (a *AlleyOrderAccessor) GroupData() {
	a._dataOrderID = map[json.Number]AlleyOrder{}
...
func (a *AlleyOrderAccessor) ByOrderID(identifier json.Number) (AlleyOrder, error) {
