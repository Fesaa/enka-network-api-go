...
type RogueMagicGambleGroupAccessor struct {
	...
	_dataGambleGroupID map[json.Number]RogueMagicGambleGroup
}
...
func (a *RogueMagicGambleGroupAccessor) GroupData() {
	a._dataGambleGroupID = map[json.Number]RogueMagicGambleGroup{}
...
func (a *RogueMagicGambleGroupAccessor) ByGambleGroupID(identifier json.Number) (RogueMagicGambleGroup, error) {
