...
type MarblePVPRankAccessor struct {
	...
	_dataID            map[json.Number]MarblePVPRank
...
func (a *MarblePVPRankAccessor) GroupData() {
	...
	a._dataID = map[json.Number]MarblePVPRank{}
...
//
// Error is only non-nil if the source errors out
func (a *MarblePVPRankAccessor) ByID(identifier json.Number) (MarblePVPRank, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
