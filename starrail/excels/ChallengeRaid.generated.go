...
type ChallengeRaidAccessor struct {
	_data               []ChallengeRaid
	_dataChallengeID    map[json.Number]ChallengeRaid
	_dataScoringGroupID map[json.Number]ChallengeRaid
}
...
func (a *ChallengeRaidAccessor) GroupData() {
	a._dataChallengeID = map[json.Number]ChallengeRaid{}
	a._dataScoringGroupID = map[json.Number]ChallengeRaid{}
...
func (a *ChallengeRaidAccessor) ByChallengeID(identifier json.Number) (ChallengeRaid, error) {
...
//
// Error is only non-nil if the source errors out
func (a *ChallengeRaidAccessor) ByScoringGroupID(identifier json.Number) (ChallengeRaid, error) {
