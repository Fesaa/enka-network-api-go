...
type TrainPartyGridTutorial struct {
	...
	PDPALBOHGAA json.Number `json:"PDPALBOHGAA"`
	PMKGKOIBKNO json.Number `json:"PMKGKOIBKNO"`
}
type TrainPartyGridTutorialAccessor struct {
	_data            []TrainPartyGridTutorial
	_dataIKFENEEPFKL map[string]TrainPartyGridTutorial
	_dataPDPALBOHGAA map[json.Number]TrainPartyGridTutorial
}
...
func (a *TrainPartyGridTutorialAccessor) GroupData() {
	a._dataIKFENEEPFKL = map[string]TrainPartyGridTutorial{}
	a._dataPDPALBOHGAA = map[json.Number]TrainPartyGridTutorial{}
...
//
// Error is only non-nil if the source errors out
func (a *TrainPartyGridTutorialAccessor) ByPDPALBOHGAA(identifier json.Number) (TrainPartyGridTutorial, error) {
