...
type PhoneThemeConfigAccessor struct {
	...
	_dataID             map[json.Number]PhoneThemeConfig
...
func (a *PhoneThemeConfigAccessor) GroupData() {
	a._dataID = map[json.Number]PhoneThemeConfig{}
...
func (a *PhoneThemeConfigAccessor) ByID(identifier json.Number) (PhoneThemeConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
