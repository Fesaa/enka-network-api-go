...
type PerformanceCGAccessor struct {
	_data                []PerformanceCG
	_dataPerformanceID   map[json.Number]PerformanceCG
...
func (a *PerformanceCGAccessor) GroupData() {
	a._dataPerformanceID = map[json.Number]PerformanceCG{}
...
func (a *PerformanceCGAccessor) ByPerformanceID(identifier json.Number) (PerformanceCG, error) {
