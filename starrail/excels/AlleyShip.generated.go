...
func (a *AlleyShipAccessor) GroupData() {
	...
	a._dataShipID = map[json.Number]AlleyShip{}
...
//
// Error is only non-nil if the source errors out
func (a *AlleyShipAccessor) ByShipID(identifier json.Number) (AlleyShip, error) {
