...
type EventMissionChallengeAccessor struct {
	...
	_dataID map[json.Number]EventMissionChallenge
}
...
func (a *EventMissionChallengeAccessor) GroupData() {
	a._dataID = map[json.Number]EventMissionChallenge{}
...
func (a *EventMissionChallengeAccessor) ByID(identifier json.Number) (EventMissionChallenge, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
