...
type ClockParkCardActionAccessor struct {
	...
	_dataCardActionID map[json.Number]ClockParkCardAction
}
...
func (a *ClockParkCardActionAccessor) GroupData() {
	a._dataCardActionID = map[json.Number]ClockParkCardAction{}
...
func (a *ClockParkCardActionAccessor) ByCardActionID(identifier json.Number) (ClockParkCardAction, error) {
