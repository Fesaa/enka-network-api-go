...
type ChallengeMazeConfigAccessor struct {
	...
	_dataID map[json.Number]ChallengeMazeConfig
}
...
func (a *ChallengeMazeConfigAccessor) GroupData() {
	a._dataID = map[json.Number]ChallengeMazeConfig{}
...
func (a *ChallengeMazeConfigAccessor) ByID(identifier json.Number) (ChallengeMazeConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
