...
type ChallengeMazeConfig struct {
	ChallengeCountDown float64       `json:"ChallengeCountDown"`
	...
	PreLevel           float64       `json:"PreLevel"`
...
type ChallengeMazeConfigAccessor struct {
	...
	_dataID map[float64]ChallengeMazeConfig
}
...
// Can be called manually in conjunction with ChallengeMazeConfigAccessor.LoadData to preload everything
func (a *ChallengeMazeConfigAccessor) GroupData() {
	a._dataID = map[float64]ChallengeMazeConfig{}
	for _, d := range a._data {
		a._dataID[d.ID] = d
	}
}

// ByID returns the ChallengeMazeConfig uniquely identified by ID
//
