...
type AvatarServantConfig struct {
	...
	Aggro                      map[string]json.Number `json:"Aggro"`
	Config                     string                 `json:"Config"`
	HPBase                     string                 `json:"HPBase"`
	HPInherit                  string                 `json:"HPInherit"`
	HPSkill                    json.Number            `json:"HPSkill"`
	...
	ServantName                map[string]json.Number `json:"ServantName"`
	...
	SpeedSkill                 json.Number            `json:"SpeedSkill"`
...
//
// Error is only non-nil if the source errors out
func (a *AvatarServantConfigAccessor) ByServantID(identifier json.Number) (AvatarServantConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *AvatarServantConfigAccessor) BySpeedSkill(identifier json.Number) (AvatarServantConfig, error) {
