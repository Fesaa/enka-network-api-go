...
type GuideChallengeDataAccessor struct {
	...
	_dataID map[json.Number]GuideChallengeData
}
...
func (a *GuideChallengeDataAccessor) GroupData() {
	a._dataID = map[json.Number]GuideChallengeData{}
...
func (a *GuideChallengeDataAccessor) ByID(identifier json.Number) (GuideChallengeData, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
