...
type PlayerPersonalCardAccessor struct {
	...
	_dataCardID            map[json.Number]PlayerPersonalCard
...
func (a *PlayerPersonalCardAccessor) GroupData() {
	a._dataCardID = map[json.Number]PlayerPersonalCard{}
...
func (a *PlayerPersonalCardAccessor) ByCardID(identifier json.Number) (PlayerPersonalCard, error) {
