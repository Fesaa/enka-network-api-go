...
type TrainPartyPassengerDiaryAccessor struct {
	...
	_dataDiaryID map[json.Number]TrainPartyPassengerDiary
}
...
func (a *TrainPartyPassengerDiaryAccessor) GroupData() {
	a._dataDiaryID = map[json.Number]TrainPartyPassengerDiary{}
...
func (a *TrainPartyPassengerDiaryAccessor) ByDiaryID(identifier json.Number) (TrainPartyPassengerDiary, error) {
