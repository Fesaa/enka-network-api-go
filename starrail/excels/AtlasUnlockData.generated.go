...
type AtlasUnlockDataAccessor struct {
	...
	_dataUnlockID map[json.Number]AtlasUnlockData
}
...
func (a *AtlasUnlockDataAccessor) GroupData() {
	a._dataUnlockID = map[json.Number]AtlasUnlockData{}
...
func (a *AtlasUnlockDataAccessor) ByUnlockID(identifier json.Number) (AtlasUnlockData, error) {
