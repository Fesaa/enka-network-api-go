...
type GachaGroupDataAccessor struct {
	...
	_dataGroupID               map[json.Number]GachaGroupData
...
func (a *GachaGroupDataAccessor) GroupData() {
	a._dataGroupID = map[json.Number]GachaGroupData{}
...
func (a *GachaGroupDataAccessor) ByGroupID(identifier json.Number) (GachaGroupData, error) {
