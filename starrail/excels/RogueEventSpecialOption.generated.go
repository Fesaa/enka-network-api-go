...
type RogueEventSpecialOption struct {
	...
	SpecialOptionID json.Number `json:"SpecialOptionID"`
}
type RogueEventSpecialOptionAccessor struct {
	...
	_dataSpecialOptionID map[json.Number]RogueEventSpecialOption
}
...
func (a *RogueEventSpecialOptionAccessor) GroupData() {
	...
	a._dataSpecialOptionID = map[json.Number]RogueEventSpecialOption{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueEventSpecialOptionAccessor) BySpecialOptionID(identifier json.Number) (RogueEventSpecialOption, error) {
