...
type RogueDLCAeonDimensionAccessor struct {
	...
	_dataAeonDimensionID map[json.Number]RogueDLCAeonDimension
...
func (a *RogueDLCAeonDimensionAccessor) GroupData() {
	a._dataAeonDimensionID = map[json.Number]RogueDLCAeonDimension{}
...
func (a *RogueDLCAeonDimensionAccessor) ByAeonDimensionID(identifier json.Number) (RogueDLCAeonDimension, error) {
