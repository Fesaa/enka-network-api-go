...
type StroyLineTrialAvatarDataAccessor struct {
	...
	_dataStoryLineID map[json.Number]StroyLineTrialAvatarData
}
...
func (a *StroyLineTrialAvatarDataAccessor) GroupData() {
	a._dataStoryLineID = map[json.Number]StroyLineTrialAvatarData{}
...
func (a *StroyLineTrialAvatarDataAccessor) ByStoryLineID(identifier json.Number) (StroyLineTrialAvatarData, error) {
