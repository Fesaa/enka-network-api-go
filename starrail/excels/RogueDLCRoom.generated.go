...
type RogueDLCRoomAccessor struct {
	_data            []RogueDLCRoom
	_dataRogueRoomID map[json.Number]RogueDLCRoom
}
...
func (a *RogueDLCRoomAccessor) GroupData() {
	a._dataRogueRoomID = map[json.Number]RogueDLCRoom{}
...
func (a *RogueDLCRoomAccessor) ByRogueRoomID(identifier json.Number) (RogueDLCRoom, error) {
