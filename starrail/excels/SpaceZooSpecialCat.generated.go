...
type SpaceZooSpecialCatAccessor struct {
	...
	_dataSpecialCatID   map[json.Number]SpaceZooSpecialCat
	_dataSpecialItem    map[json.Number]SpaceZooSpecialCat
}
...
func (a *SpaceZooSpecialCatAccessor) GroupData() {
	...
	a._dataSpecialCatID = map[json.Number]SpaceZooSpecialCat{}
	a._dataSpecialItem = map[json.Number]SpaceZooSpecialCat{}
...
//
// Error is only non-nil if the source errors out
func (a *SpaceZooSpecialCatAccessor) BySpecialCatID(identifier json.Number) (SpaceZooSpecialCat, error) {
...
//
// Error is only non-nil if the source errors out
func (a *SpaceZooSpecialCatAccessor) BySpecialItem(identifier json.Number) (SpaceZooSpecialCat, error) {
