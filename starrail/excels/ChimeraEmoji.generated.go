...
type ChimeraEmojiAccessor struct {
	_data          []ChimeraEmoji
	_dataEmojiID   map[json.Number]ChimeraEmoji
...
func (a *ChimeraEmojiAccessor) GroupData() {
	a._dataEmojiID = map[json.Number]ChimeraEmoji{}
...
func (a *ChimeraEmojiAccessor) ByEmojiID(identifier json.Number) (ChimeraEmoji, error) {
