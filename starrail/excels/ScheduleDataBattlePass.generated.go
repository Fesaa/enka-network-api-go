...
type ScheduleDataBattlePassAccessor struct {
	...
	_dataID        map[json.Number]ScheduleDataBattlePass
}
...
func (a *ScheduleDataBattlePassAccessor) GroupData() {
	...
	a._dataID = map[json.Number]ScheduleDataBattlePass{}
...
//
// Error is only non-nil if the source errors out
func (a *ScheduleDataBattlePassAccessor) ByID(identifier json.Number) (ScheduleDataBattlePass, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
