...
type DialoguePropAccessor struct {
	_data        []DialogueProp
	_dataGroupID map[json.Number]DialogueProp
}
...
func (a *DialoguePropAccessor) GroupData() {
	a._dataGroupID = map[json.Number]DialogueProp{}
...
func (a *DialoguePropAccessor) ByGroupID(identifier json.Number) (DialogueProp, error) {
