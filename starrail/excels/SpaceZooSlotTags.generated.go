...
type SpaceZooSlotTagsAccessor struct {
	...
	_dataFeatureID map[json.Number]SpaceZooSlotTags
...
func (a *SpaceZooSlotTagsAccessor) GroupData() {
	a._dataFeatureID = map[json.Number]SpaceZooSlotTags{}
...
func (a *SpaceZooSlotTagsAccessor) ByFeatureID(identifier json.Number) (SpaceZooSlotTags, error) {
