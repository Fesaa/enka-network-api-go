...
type MatchThreeSkillAccessor struct {
	...
	_dataSkillID   map[json.Number]MatchThreeSkill
...
func (a *MatchThreeSkillAccessor) GroupData() {
	a._dataSkillID = map[json.Number]MatchThreeSkill{}
...
func (a *MatchThreeSkillAccessor) BySkillID(identifier json.Number) (MatchThreeSkill, error) {
