...
type VoiceConfigAccessor struct {
	_data        []VoiceConfig
	_dataVoiceID map[json.Number]VoiceConfig
}
...
func (a *VoiceConfigAccessor) GroupData() {
	a._dataVoiceID = map[json.Number]VoiceConfig{}
...
func (a *VoiceConfigAccessor) ByVoiceID(identifier json.Number) (VoiceConfig, error) {
