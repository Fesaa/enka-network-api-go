...
type PerformanceVideoAccessor struct {
	...
	_dataPerformanceID   map[json.Number]PerformanceVideo
...
func (a *PerformanceVideoAccessor) GroupData() {
	a._dataPerformanceID = map[json.Number]PerformanceVideo{}
...
func (a *PerformanceVideoAccessor) ByPerformanceID(identifier json.Number) (PerformanceVideo, error) {
