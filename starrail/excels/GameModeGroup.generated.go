...
type GameModeGroupAccessor struct {
	_data                []GameModeGroup
	_dataGameModeGroupID map[json.Number]GameModeGroup
}
...
func (a *GameModeGroupAccessor) GroupData() {
	a._dataGameModeGroupID = map[json.Number]GameModeGroup{}
...
func (a *GameModeGroupAccessor) ByGameModeGroupID(identifier json.Number) (GameModeGroup, error) {
