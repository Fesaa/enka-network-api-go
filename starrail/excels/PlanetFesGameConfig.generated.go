...
type PlanetFesGameConfigAccessor struct {
	...
	_dataLandID       map[json.Number]PlanetFesGameConfig
	_dataParamInt3    map[json.Number]PlanetFesGameConfig
	_dataParamStr1    map[string]PlanetFesGameConfig
	_dataRaiseCurveID map[json.Number]PlanetFesGameConfig
	_dataRewardPool   map[json.Number]PlanetFesGameConfig
}
...
func (a *PlanetFesGameConfigAccessor) GroupData() {
	...
	a._dataLandID = map[json.Number]PlanetFesGameConfig{}
	a._dataParamInt3 = map[json.Number]PlanetFesGameConfig{}
	a._dataParamStr1 = map[string]PlanetFesGameConfig{}
	a._dataRaiseCurveID = map[json.Number]PlanetFesGameConfig{}
	a._dataRewardPool = map[json.Number]PlanetFesGameConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *PlanetFesGameConfigAccessor) ByLandID(identifier json.Number) (PlanetFesGameConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *PlanetFesGameConfigAccessor) ByParamInt3(identifier json.Number) (PlanetFesGameConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *PlanetFesGameConfigAccessor) ByRaiseCurveID(identifier json.Number) (PlanetFesGameConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *PlanetFesGameConfigAccessor) ByRewardPool(identifier json.Number) (PlanetFesGameConfig, error) {
