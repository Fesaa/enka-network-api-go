...
type SpecialAvatarRelicAccessor struct {
	...
	_dataRelicPropertyType map[json.Number]SpecialAvatarRelic
}
...
func (a *SpecialAvatarRelicAccessor) GroupData() {
	a._dataRelicPropertyType = map[json.Number]SpecialAvatarRelic{}
...
func (a *SpecialAvatarRelicAccessor) ByRelicPropertyType(identifier json.Number) (SpecialAvatarRelic, error) {
