...
type BookSeriesConfigAccessor struct {
	...
	_dataBookSeriesID map[json.Number]BookSeriesConfig
}
...
func (a *BookSeriesConfigAccessor) GroupData() {
	a._dataBookSeriesID = map[json.Number]BookSeriesConfig{}
...
func (a *BookSeriesConfigAccessor) ByBookSeriesID(identifier json.Number) (BookSeriesConfig, error) {
