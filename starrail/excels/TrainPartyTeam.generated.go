...
type TrainPartyTeamAccessor struct {
	...
	_dataTeamID map[json.Number]TrainPartyTeam
}
...
func (a *TrainPartyTeamAccessor) GroupData() {
	a._dataTeamID = map[json.Number]TrainPartyTeam{}
...
func (a *TrainPartyTeamAccessor) ByTeamID(identifier json.Number) (TrainPartyTeam, error) {
