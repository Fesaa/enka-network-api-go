...
type ClockParkStoryAccessor struct {
	...
	_dataStoryID       map[json.Number]ClockParkStory
...
func (a *ClockParkStoryAccessor) GroupData() {
	a._dataStoryID = map[json.Number]ClockParkStory{}
...
func (a *ClockParkStoryAccessor) ByStoryID(identifier json.Number) (ClockParkStory, error) {
