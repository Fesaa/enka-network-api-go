...
type TrainPassengerConfigAccessor struct {
	...
	_dataPassengerID map[json.Number]TrainPassengerConfig
}
...
func (a *TrainPassengerConfigAccessor) GroupData() {
	a._dataPassengerID = map[json.Number]TrainPassengerConfig{}
...
func (a *TrainPassengerConfigAccessor) ByPassengerID(identifier json.Number) (TrainPassengerConfig, error) {
