...
type TitanAtlasGroupAccessor struct {
	...
	_dataTitanGroupID map[json.Number]TitanAtlasGroup
...
func (a *TitanAtlasGroupAccessor) GroupData() {
	a._dataTitanGroupID = map[json.Number]TitanAtlasGroup{}
...
func (a *TitanAtlasGroupAccessor) ByTitanGroupID(identifier json.Number) (TitanAtlasGroup, error) {
