...
type ChallengeStoryThemeAccessor struct {
	...
	_dataThemeID              map[json.Number]ChallengeStoryTheme
...
func (a *ChallengeStoryThemeAccessor) GroupData() {
	a._dataThemeID = map[json.Number]ChallengeStoryTheme{}
...
func (a *ChallengeStoryThemeAccessor) ByThemeID(identifier json.Number) (ChallengeStoryTheme, error) {
