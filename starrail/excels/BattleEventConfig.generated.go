...
type BattleEventConfigAccessor struct {
	...
	_dataBattleEventID map[json.Number]BattleEventConfig
}
...
func (a *BattleEventConfigAccessor) GroupData() {
	a._dataBattleEventID = map[json.Number]BattleEventConfig{}
...
func (a *BattleEventConfigAccessor) ByBattleEventID(identifier json.Number) (BattleEventConfig, error) {
