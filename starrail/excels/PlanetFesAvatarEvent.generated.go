...
type PlanetFesAvatarEventAccessor struct {
	...
	_dataID      map[json.Number]PlanetFesAvatarEvent
...
func (a *PlanetFesAvatarEventAccessor) GroupData() {
	a._dataID = map[json.Number]PlanetFesAvatarEvent{}
...
func (a *PlanetFesAvatarEventAccessor) ByID(identifier json.Number) (PlanetFesAvatarEvent, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
