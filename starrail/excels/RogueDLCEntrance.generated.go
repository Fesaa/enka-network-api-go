...
type RogueDLCEntrance struct {
	...
	SubTypeTitle        map[string]json.Number `json:"SubTypeTitle"`
...
type RogueDLCEntranceAccessor struct {
	...
	_dataID                  map[json.Number]RogueDLCEntrance
...
func (a *RogueDLCEntranceAccessor) GroupData() {
	...
	a._dataID = map[json.Number]RogueDLCEntrance{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueDLCEntranceAccessor) ByID(identifier json.Number) (RogueDLCEntrance, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
