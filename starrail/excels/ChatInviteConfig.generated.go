...
type ChatInviteConfigAccessor struct {
	...
	_dataID      map[json.Number]ChatInviteConfig
...
func (a *ChatInviteConfigAccessor) GroupData() {
	a._dataID = map[json.Number]ChatInviteConfig{}
...
func (a *ChatInviteConfigAccessor) ByID(identifier json.Number) (ChatInviteConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
