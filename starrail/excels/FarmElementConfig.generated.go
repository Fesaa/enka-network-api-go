...
type FarmElementConfigAccessor struct {
	...
	_dataStageID map[json.Number]FarmElementConfig
}
...
func (a *FarmElementConfigAccessor) GroupData() {
	a._dataStageID = map[json.Number]FarmElementConfig{}
...
func (a *FarmElementConfigAccessor) ByStageID(identifier json.Number) (FarmElementConfig, error) {
