...
type ActivityAvatarConfigAccessor struct {
	...
	_dataAdventurePlayerID         map[json.Number]ActivityAvatarConfig
	...
	_dataAvatarID                  map[json.Number]ActivityAvatarConfig
...
func (a *ActivityAvatarConfigAccessor) GroupData() {
	...
	a._dataAdventurePlayerID = map[json.Number]ActivityAvatarConfig{}
	...
	a._dataAvatarID = map[json.Number]ActivityAvatarConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *ActivityAvatarConfigAccessor) ByAdventurePlayerID(identifier json.Number) (ActivityAvatarConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *ActivityAvatarConfigAccessor) ByAvatarID(identifier json.Number) (ActivityAvatarConfig, error) {
