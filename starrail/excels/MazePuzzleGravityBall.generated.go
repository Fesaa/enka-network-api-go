...
type MazePuzzleGravityBallAccessor struct {
	...
	_dataPuzzleID   map[json.Number]MazePuzzleGravityBall
...
func (a *MazePuzzleGravityBallAccessor) GroupData() {
	a._dataPuzzleID = map[json.Number]MazePuzzleGravityBall{}
...
func (a *MazePuzzleGravityBallAccessor) ByPuzzleID(identifier json.Number) (MazePuzzleGravityBall, error) {
