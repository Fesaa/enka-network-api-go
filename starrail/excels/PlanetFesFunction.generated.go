...
type PlanetFesFunctionAccessor struct {
	...
	_dataSkillID map[json.Number]PlanetFesFunction
}
...
func (a *PlanetFesFunctionAccessor) GroupData() {
	a._dataSkillID = map[json.Number]PlanetFesFunction{}
...
func (a *PlanetFesFunctionAccessor) BySkillID(identifier json.Number) (PlanetFesFunction, error) {
