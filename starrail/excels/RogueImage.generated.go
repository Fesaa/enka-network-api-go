...
type RogueImageAccessor struct {
	_data          []RogueImage
	_dataImageID   map[json.Number]RogueImage
...
func (a *RogueImageAccessor) GroupData() {
	a._dataImageID = map[json.Number]RogueImage{}
...
func (a *RogueImageAccessor) ByImageID(identifier json.Number) (RogueImage, error) {
