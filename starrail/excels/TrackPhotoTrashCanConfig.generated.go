...
type TrackPhotoTrashCanConfigAccessor struct {
	...
	_dataNpcTemplateID map[json.Number]TrackPhotoTrashCanConfig
}
...
func (a *TrackPhotoTrashCanConfigAccessor) GroupData() {
	...
	a._dataNpcTemplateID = map[json.Number]TrackPhotoTrashCanConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *TrackPhotoTrashCanConfigAccessor) ByNpcTemplateID(identifier json.Number) (TrackPhotoTrashCanConfig, error) {
