...
type RogueAdventureRoomAccessor struct {
	...
	_dataParamGroupID map[float64]RogueAdventureRoom
	_dataRoomID       map[float64]RogueAdventureRoom
}
...
func (a *RogueAdventureRoomAccessor) GroupData() {
	a._dataParamGroupID = map[float64]RogueAdventureRoom{}
	a._dataRoomID = map[float64]RogueAdventureRoom{}
...
func (a *RogueAdventureRoomAccessor) ByParamGroupID(identifier float64) (RogueAdventureRoom, error) {
...
//
// Error is only non-nil if the source errors out
func (a *RogueAdventureRoomAccessor) ByRoomID(identifier float64) (RogueAdventureRoom, error) {
