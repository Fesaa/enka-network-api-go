...
type TeleportConfigAccessor struct {
	...
	_dataID map[json.Number]TeleportConfig
}
...
func (a *TeleportConfigAccessor) GroupData() {
	a._dataID = map[json.Number]TeleportConfig{}
...
func (a *TeleportConfigAccessor) ByID(identifier json.Number) (TeleportConfig, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
