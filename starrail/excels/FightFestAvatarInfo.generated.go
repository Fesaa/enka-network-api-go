...
type FightFestAvatarInfoAccessor struct {
	...
	_dataAvatarID  map[json.Number]FightFestAvatarInfo
...
func (a *FightFestAvatarInfoAccessor) GroupData() {
	a._dataAvatarID = map[json.Number]FightFestAvatarInfo{}
...
func (a *FightFestAvatarInfoAccessor) ByAvatarID(identifier json.Number) (FightFestAvatarInfo, error) {
