...
type RogueMagicNPCAccessor struct {
	...
	_dataRogueNPCID  map[json.Number]RogueMagicNPC
}
...
func (a *RogueMagicNPCAccessor) GroupData() {
	...
	a._dataRogueNPCID = map[json.Number]RogueMagicNPC{}
...
//
// Error is only non-nil if the source errors out
func (a *RogueMagicNPCAccessor) ByRogueNPCID(identifier json.Number) (RogueMagicNPC, error) {
