...
type AchievementSeriesAccessor struct {
	...
	_dataSeriesID       map[json.Number]AchievementSeries
...
func (a *AchievementSeriesAccessor) GroupData() {
	...
	a._dataSeriesID = map[json.Number]AchievementSeries{}
...
//
// Error is only non-nil if the source errors out
func (a *AchievementSeriesAccessor) BySeriesID(identifier json.Number) (AchievementSeries, error) {
