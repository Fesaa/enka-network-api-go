...
type MonopolyQuizPlayerConfigAccessor struct {
	...
	_dataQuizPlayerID map[json.Number]MonopolyQuizPlayerConfig
}
...
func (a *MonopolyQuizPlayerConfigAccessor) GroupData() {
	...
	a._dataQuizPlayerID = map[json.Number]MonopolyQuizPlayerConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *MonopolyQuizPlayerConfigAccessor) ByQuizPlayerID(identifier json.Number) (MonopolyQuizPlayerConfig, error) {
