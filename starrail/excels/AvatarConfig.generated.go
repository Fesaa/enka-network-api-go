...
type AvatarConfigAccessor struct {
	...
	_dataAdventurePlayerID         map[json.Number]AvatarConfig
	...
	_dataAvatarID                  map[json.Number]AvatarConfig
...
func (a *AvatarConfigAccessor) GroupData() {
	...
	a._dataAdventurePlayerID = map[json.Number]AvatarConfig{}
	...
	a._dataAvatarID = map[json.Number]AvatarConfig{}
...
//
// Error is only non-nil if the source errors out
func (a *AvatarConfigAccessor) ByAdventurePlayerID(identifier json.Number) (AvatarConfig, error) {
...
//
// Error is only non-nil if the source errors out
func (a *AvatarConfigAccessor) ByAvatarID(identifier json.Number) (AvatarConfig, error) {
