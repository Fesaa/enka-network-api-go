...
type PlanetFesGameBingoSymbolAccessor struct {
	...
	_dataID       map[json.Number]PlanetFesGameBingoSymbol
...
func (a *PlanetFesGameBingoSymbolAccessor) GroupData() {
	a._dataID = map[json.Number]PlanetFesGameBingoSymbol{}
...
func (a *PlanetFesGameBingoSymbolAccessor) ByID(identifier json.Number) (PlanetFesGameBingoSymbol, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
