...
type ContentPackageConfigAccessor struct {
	...
	_dataContentID map[json.Number]ContentPackageConfig
}
...
func (a *ContentPackageConfigAccessor) GroupData() {
	a._dataContentID = map[json.Number]ContentPackageConfig{}
...
func (a *ContentPackageConfigAccessor) ByContentID(identifier json.Number) (ContentPackageConfig, error) {
