...
type MultiplePathAvatarConfigAccessor struct {
	...
	_dataAvatarID         map[json.Number]MultiplePathAvatarConfig
...
func (a *MultiplePathAvatarConfigAccessor) GroupData() {
	a._dataAvatarID = map[json.Number]MultiplePathAvatarConfig{}
...
func (a *MultiplePathAvatarConfigAccessor) ByAvatarID(identifier json.Number) (MultiplePathAvatarConfig, error) {
