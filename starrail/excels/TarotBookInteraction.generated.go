...
type TarotBookInteractionAccessor struct {
	...
	_dataID       map[json.Number]TarotBookInteraction
	_dataJsonPath map[string]TarotBookInteraction
	_dataPriority map[json.Number]TarotBookInteraction
}
...
func (a *TarotBookInteractionAccessor) GroupData() {
	a._dataID = map[json.Number]TarotBookInteraction{}
	a._dataJsonPath = map[string]TarotBookInteraction{}
	a._dataPriority = map[json.Number]TarotBookInteraction{}
...
func (a *TarotBookInteractionAccessor) ByID(identifier json.Number) (TarotBookInteraction, error) {
	if a._dataID == nil {
		if a._data == nil {
			err := a.LoadData()
			if err != nil {
...
//
// Error is only non-nil if the source errors out
func (a *TarotBookInteractionAccessor) ByPriority(identifier json.Number) (TarotBookInteraction, error) {
