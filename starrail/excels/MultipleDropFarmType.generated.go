...
type MultipleDropFarmTypeAccessor struct {
	...
	_dataUnlockID         map[json.Number]MultipleDropFarmType
}
...
func (a *MultipleDropFarmTypeAccessor) GroupData() {
	...
	a._dataUnlockID = map[json.Number]MultipleDropFarmType{}
...
//
// Error is only non-nil if the source errors out
func (a *MultipleDropFarmTypeAccessor) ByUnlockID(identifier json.Number) (MultipleDropFarmType, error) {
